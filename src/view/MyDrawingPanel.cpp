...
/*
	...
	else if(control->Id_Bouton == 2){dc.DrawCircle(m_listclicks[0], else if(control->Id_Bouton == 2){dc.DrawCircle(m_listclicks[0], sqrt((pow(m_listclicks[1].x,2))+pow(m_listclicks[1].y,2)));}
